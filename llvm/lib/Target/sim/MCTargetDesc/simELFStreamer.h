//===-- simELFStreamer.h - sim ELF Target Streamer ---------*- C++ -*--===//
//
...
#ifndef LLVM_LIB_TARGET_sim_MCTARGETDESC_simELFSTREAMER_H
#define LLVM_LIB_TARGET_sim_MCTARGETDESC_simELFSTREAMER_H
...
class simTargetELFStreamer : public simTargetStreamer {
private:
...
public:
  ...
  simTargetELFStreamer(MCStreamer &S, const MCSubtargetInfo &STI);
