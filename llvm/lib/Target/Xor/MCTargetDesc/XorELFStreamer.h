//===-- XorELFStreamer.h - Xor ELF Target Streamer ---------*- C++ -*--===//
//
...
#ifndef LLVM_LIB_TARGET_Xor_MCTARGETDESC_XorELFSTREAMER_H
#define LLVM_LIB_TARGET_Xor_MCTARGETDESC_XorELFSTREAMER_H
...
class XorTargetELFStreamer : public XorTargetStreamer {
private:
...
public:
  ...
  XorTargetELFStreamer(MCStreamer &S, const MCSubtargetInfo &STI);
