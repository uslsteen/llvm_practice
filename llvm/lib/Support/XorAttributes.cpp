//===-- XorAttributes.cpp - Xor Attributes ----------------------------===//
//
...
constexpr TagNameMap XorAttributeTags{tagData};
const TagNameMap &llvm::XorAttrs::getXorAttributeTags() {
  return XorAttributeTags;
}
