//===-- XorISAInfo.cpp - Xor Arch String Parser --------------===//
//
...
struct XorExtensionVersion {
  unsigned Major;
  unsigned Minor;
};

struct XorSupportedExtension {
  const char *Name;
  /// Supported version.
  XorExtensionVersion Version;
};
...
static const XorSupportedExtension SupportedExtensions[] = {
    {"i", XorExtensionVersion{2, 0}},
    {"e", XorExtensionVersion{1, 9}},
    {"m", XorExtensionVersion{2, 0}},
    {"a", XorExtensionVersion{2, 0}},
    {"f", XorExtensionVersion{2, 0}},
    {"d", XorExtensionVersion{2, 0}},
    {"c", XorExtensionVersion{2, 0}},

    {"zfhmin", XorExtensionVersion{1, 0}},
    {"zfh", XorExtensionVersion{1, 0}},

    {"zba", XorExtensionVersion{1, 0}},
    {"zbb", XorExtensionVersion{1, 0}},
    {"zbc", XorExtensionVersion{1, 0}},
    {"zbs", XorExtensionVersion{1, 0}},

    {"zbkb", XorExtensionVersion{1, 0}},
    {"zbkc", XorExtensionVersion{1, 0}},
    {"zbkx", XorExtensionVersion{1, 0}},
    {"zknd", XorExtensionVersion{1, 0}},
    {"zkne", XorExtensionVersion{1, 0}},
    {"zknh", XorExtensionVersion{1, 0}},
    {"zksed", XorExtensionVersion{1, 0}},
    {"zksh", XorExtensionVersion{1, 0}},
    {"zkr", XorExtensionVersion{1, 0}},
    {"zkn", XorExtensionVersion{1, 0}},
    {"zks", XorExtensionVersion{1, 0}},
    {"zkt", XorExtensionVersion{1, 0}},
    {"zk", XorExtensionVersion{1, 0}},

    {"v", XorExtensionVersion{1, 0}},
    {"zvl32b", XorExtensionVersion{1, 0}},
    {"zvl64b", XorExtensionVersion{1, 0}},
    {"zvl128b", XorExtensionVersion{1, 0}},
    {"zvl256b", XorExtensionVersion{1, 0}},
    {"zvl512b", XorExtensionVersion{1, 0}},
    {"zvl1024b", XorExtensionVersion{1, 0}},
    {"zvl2048b", XorExtensionVersion{1, 0}},
    {"zvl4096b", XorExtensionVersion{1, 0}},
    {"zvl8192b", XorExtensionVersion{1, 0}},
    {"zvl16384b", XorExtensionVersion{1, 0}},
    {"zvl32768b", XorExtensionVersion{1, 0}},
    {"zvl65536b", XorExtensionVersion{1, 0}},
    {"zve32x", XorExtensionVersion{1, 0}},
    {"zve32f", XorExtensionVersion{1, 0}},
    {"zve64x", XorExtensionVersion{1, 0}},
    {"zve64f", XorExtensionVersion{1, 0}},
    {"zve64d", XorExtensionVersion{1, 0}},
};

static const XorSupportedExtension SupportedExperimentalExtensions[] = {
    {"zbe", XorExtensionVersion{0, 93}},
    {"zbf", XorExtensionVersion{0, 93}},
    {"zbm", XorExtensionVersion{0, 93}},
    {"zbp", XorExtensionVersion{0, 93}},
    {"zbr", XorExtensionVersion{0, 93}},
    {"zbt", XorExtensionVersion{0, 93}},
};
...
struct FindByName {
  ...
  StringRef Ext;
  bool operator()(const XorSupportedExtension &ExtInfo) {
    return ExtInfo.Name == Ext;
  }
};

static Optional<XorExtensionVersion> findDefaultVersion(StringRef ExtName) {
...
void XorISAInfo::addExtension(StringRef ExtName, unsigned MajorVersion,
                                unsigned MinorVersion) {
  XorExtensionInfo Ext;
...
static Optional<XorExtensionVersion> isExperimentalExtension(StringRef Ext) {
  auto ExtIterator =
...
bool XorISAInfo::isSupportedExtensionFeature(StringRef Ext) {
...
bool XorISAInfo::isSupportedExtension(StringRef Ext) {
  return llvm::any_of(SupportedExtensions, FindByName(Ext)) ||
         llvm::any_of(SupportedExperimentalExtensions, FindByName(Ext));
}

bool XorISAInfo::isSupportedExtension(StringRef Ext, unsigned MajorVersion,
                                        unsigned MinorVersion) {
  auto FindByNameAndVersion = [=](const XorSupportedExtension &ExtInfo) {
...
bool XorISAInfo::hasExtension(StringRef Ext) const {
...
bool XorISAInfo::compareExtension(const std::string &LHS,
...
static Error getExtensionVersion(StringRef Ext, StringRef In, unsigned &Major,
  ...
  if (XorISAInfo::isSupportedExtension(Ext, Major, Minor))
    return Error::success();
...
llvm::Expected<std::unique_ptr<XorISAInfo>>
XorISAInfo::parseFeatures(unsigned XLen,
                            const std::vector<std::string> &Features) {
  assert(XLen == 32 || XLen == 64);
  std::unique_ptr<XorISAInfo> ISAInfo(new XorISAInfo(XLen));
  ...
  return XorISAInfo::postProcessAndChecking(std::move(ISAInfo));
}

llvm::Expected<std::unique_ptr<XorISAInfo>>
XorISAInfo::parseArchString(StringRef Arch, bool EnableExperimentalExtension,
                              bool ExperimentalExtensionVersionCheck) {
...
Error XorISAInfo::checkDependency() {
  bool IsRv32 = XLen == 32;
...
void XorISAInfo::updateImplication() {
  bool HasE = Exts.count("e") != 0;
...
std::string XorISAInfo::toString() const {
  std::string Buffer;
...
std::vector<std::string> XorISAInfo::toFeatureVector() const {
...
llvm::Expected<std::unique_ptr<XorISAInfo>>
XorISAInfo::postProcessAndChecking(std::unique_ptr<XorISAInfo> &&ISAInfo) {
